...
def create_control_components(adata, prefix, *, role="left", default_embedding=None):
    ...
    coordinates_dropdowns = html.Div(
        ...
        style={"marginBottom": "15px", "fontSize": "14px"} if initial_embedding == "X_pca" else {"display": "none"},
    )
...
def generate_embedding_plots(adata, prefix, scatter_defaults=None):
    ...
    colorscales = continuous_colormap_options()
    ...
    graphic_control = html.Div(
        ...
        children=[
            ...
            html.Div([html.Label("Continuous ColorMap:", className="control-label"), color_map_dropdown], className="dbc", style={"marginBottom": "15px"}),
