...
def _extract_and_cache_violin_data(adata, genes, labels, groupby, transformation, data_already_filtered=False):
    ...
    cache_key = _create_cache_key(
        ...
        groupby,
        transformation,
        f"{adata_id}_prefilter={data_already_filtered}",
    )
...
def plot_violin1(
    ...
    cached_data = _extract_and_cache_violin_data(
        adata, genes, labels, groupby, transformation, data_already_filtered=data_already_filtered
    )
